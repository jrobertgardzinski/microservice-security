...
public record SessionConfig(int refreshTokenValidityHours, int accessTokenValidityHours) {
    public SessionConfig {
        if (refreshTokenValidityHours < 1) throw new IllegalArgumentException("refreshTokenValidityHours must be at least 1");
        if (accessTokenValidityHours < 1) throw new IllegalArgumentException("accessTokenValidityHours must be at least 1");
    }
