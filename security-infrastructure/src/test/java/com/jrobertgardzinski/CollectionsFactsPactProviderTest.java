...
/**
 * Verifies microservice-user-collections' committed pact — the saved lists' view of {@code EMAIL_CHANGED},
...
@PactFolder("../../../portal/microservice-user-collections/pacts")
@EnabledIf(value = "consumerPactsCheckedOut",
        disabledReason = "microservice-user-collections is not checked out in the portal workspace")
class CollectionsFactsPactProviderTest {

    static boolean consumerPactsCheckedOut() {
        return Files.isDirectory(Path.of("../../../portal/microservice-user-collections/pacts"));
    }
    ...
    void everyFactShapeTheListsRelyOn(PactVerificationContext context) {
