...
driving the *same Gherkin* through a real React UI in a real browser — same behaviour, a third
entry point.

## The app

A deliberately plain React app (Vite + TS, the same stack as the meme gallery): sign in, create an account, the "check your mailbox"
